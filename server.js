...
app.post('/housingApp', function(req, res) {
  var data = req.body;
  var b = parseInt(req.body.full_bathrooms) + parseFloat(((req.body.half_bathrooms)/2));
  data.Bathrooms = b;
  var m = Math.log(req.body.Area);
  data.larea = m;
  if (data.Zipcode == 94134){
    adjustment = .0402;
  }
  if (data.Zipcode == 94124){
    adjustment = -.3257;
  }
  if (data.Zipcode == 94112){
    adjustment = -.3832;
  }
  if (data.Zipcode == 94105){
    adjustment = -.1971;
  }
  if (data.Zipcode == 94132){
    adjustment = .0046;
  }
  if (data.Zipcode == 94121){
    adjustment = .0131;
  }
  if (data.Zipcode == 94123){
    adjustment = .5297;
  }
  if (data.Zipcode == 94116){
    adjustment = -.0626;
  }
  if (data.Zipcode == 94133){
    adjustment = .3156;
  }
  if (data.Zipcode == 94122){
    adjustment = .3876;
  }
  if (data.Zipcode == 94108){
    adjustment = .2792;
  }
  if (data.Zipcode == 94109){
    adjustment = .2277;
  }
  if (data.Zipcode == 94158){
    adjustment = -.7669;
  }
  if (data.Zipcode == 94127){
    adjustment = -.1167;
  }
  if (data.Zipcode == 94118){
    adjustment = .0738;
  }
  if (data.Zipcode == 94111){
    adjustment = -.2653;
  }
  if (data.Zipcode == 94114){
    adjustment = .1382;
  }
  if (data.Zipcode == 94110){
    adjustment = .1602;
  }
  if (data.Zipcode == 94107){
    adjustment = -.2406;
  }
  if (data.Zipcode == 94115){
    adjustment = .4735;
  }
  if (data.Zipcode == 94103){
    adjustment = .1049;
  }
  if (data.Zipcode == 94117){
    adjustment = -.0444;
  }
  if (data.Zipcode == 94131){
    adjustment = -.0490;
  }
  request({
    url: 'http://user1@demo.com:scoredata1234@console.scoredata.com/api/score/',
